...
export function SummaryCard({ icon: Icon, title, value, detail, tone = 'blue' }: { icon: typeof Activity; title: string; value: string; detail: string; tone?: 'blue' | 'green' | 'orange' | 'red' }) {
